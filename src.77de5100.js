...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"section.ts":[function(require,module,exports) {
"use strict";

exports.__esModule = true;

exports.createSection = function (title) {
  var container = document.createElement('section');
  container.innerHTML = "<h2 class=\"js-title\"></h2><div class=\"js-body\"></div>";
  var titleEl = container.querySelector('.js-title');
  titleEl.textContent = title;
  var body = container.querySelector('.js-body');
  return {
...
},{"./bundle-url":"../../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"../../src/Common/common.css":[function(require,module,exports) {
...
},{"../lit-html.js":"../../node_modules/lit-html/lit-html.js"}],"../../src/common/Component.ts":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  Component.prototype.template = function (props) {
    if (props === void 0) {
      props = {};
    }
  ...
  Object.defineProperty(Component.prototype, "fragmentEl", {
    get: function get() {
      if (!this._fragmentEl) {
  ...
  Component.prototype.render = function () {
    lit_html_1.render(this.template(this.state), this.fragmentEl);
    var isRerendered = !this.el;
  ...
  Component.prototype.renderTo = function (container) {
  ...
  Component.prototype._bindEventsFromProps = function (props) {
    var _this = this;

    Object.keys(props).filter(function (name) {
      return typeof props[name] === 'function';
    }).forEach(function (name) {
      var matched = name.match(/(^on)([A-Z].*)/); //e.g. onClick, onActive

      if (!matched) {
        return;
      }

      var event = lcfirst(matched[2]);

      _this.on(event, props[name]);
    });
  };
  ...
  Component.prototype._bindEvents = function () {
    ...
    Object.keys(this._eventsToBind).forEach(function (event) {
      _this._eventsToBind[event].forEach(function (fn) {
        _this.on(event, fn);
      });
    });
  };
...
},{"lit-html":"../../node_modules/lit-html/lit-html.js"}],"../../src/common/index.ts":[function(require,module,exports) {
"use strict";
...
},{"lit-html":"../../node_modules/lit-html/lit-html.js","lit-html/directives/class-map":"../../node_modules/lit-html/directives/class-map.js","./Component":"../../src/common/Component.ts"}],"../../src/Button/Button.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../../src/Button/Button.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  Button.prototype.template = function (_a) {
    var text = _a.text,
        _b = _a.type,
        type = _b === void 0 ? 'normal' : _b,
        _c = _a.isVisible,
    ...
    return common_1.html(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n      <button class=", " ?disabled=", ">\n        ", "\n      </button>\n    "], ["\n      <button class=", " ?disabled=", ">\n        ", "\n      </button>\n    "])), common_1.classMap(classes), isDisabled, text);
  };
...
},{"../common":"../../src/common/index.ts","./Button.css":"../../src/Button/Button.css"}],"../../src/Button/index.ts":[function(require,module,exports) {
"use strict";
...
},{"./Button":"../../src/Button/Button.ts"}],"../../src/Text/Text.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../../src/Text/Text.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  Text.prototype.template = function (_a) {
    var _b = _a.value,
        value = _b === void 0 ? '' : _b,
        _c = _a.isVisible,
        isVisible = _c === void 0 ? true : _c,
...
var templateObject_1;
},{"../common":"../../src/common/index.ts","./Text.css":"../../src/Text/Text.css"}],"../../src/Text/index.ts":[function(require,module,exports) {
"use strict";
...
},{"./Text":"../../src/Text/Text.ts"}],"../../node_modules/lit-html/directives/style-map.js":[function(require,module,exports) {
"use strict";
...
const styleMap = (0, _litHtml.directive)(styleInfo => part => {
  ...
  const style = part.committer.element.style; // Remove old properties that no longer exist in styleInfo
...
},{"../lit-html.js":"../../node_modules/lit-html/lit-html.js"}],"../../src/common/list-item-template.ts":[function(require,module,exports) {
"use strict";
...
exports.listItemTemplate = function (props) {
  ...
  if (props.type === 'checkbox' || props.type === 'radio') {
    ...
    return lit_html_1.html(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n      <span className=", ">\n        <input\n          name=", "\n          id=", "\n          disabled=", "\n          type=", "\n          checked=", "\n          @change=", "\n        />\n        <label for=", ">", " </label>\n      </span>\n    "], ["\n      <span className=", ">\n        <input\n          name=", "\n          id=", "\n          disabled=", "\n          type=", "\n          checked=", "\n          @change=", "\n        />\n        <label for=", ">", " </label>\n      </span>\n    "])), props.className, props.name, id, props.isDisabled, props.type, props.selected, _onChange, id, props.item.label);
  }

  var className = ['kuc-list-item', props.selected ? 'kuc-list-item-selected' : '', props.isDisabled ? 'kuc-list-item-disable' : ''];
  return lit_html_1.html(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n    <div\n      @click=", "\n      class=", "\n      .disabled=", "\n    >\n      <span class=\"kuc-icon-check\"\n        ><i class=\"fa fa-check\" aria-hidden=\"true\"></i\n      ></span>\n      <span class=\"kuc-list-item-label\">", "</span>\n    </div>\n  "], ["\n    <div\n      @click=", "\n      class=", "\n      .disabled=", "\n    >\n      <span class=\"kuc-icon-check\"\n        ><i class=\"fa fa-check\" aria-hidden=\"true\"></i\n      ></span>\n      <span class=\"kuc-list-item-label\">", "</span>\n    </div>\n  "])), _onClick, className.join(' ').trim(), props.isDisabled, props.item.label);
};

exports["default"] = exports.listItemTemplate;
var templateObject_1, templateObject_2;
},{"lit-html":"../../node_modules/lit-html/lit-html.js"}],"../../src/common/selection-single.ts":[function(require,module,exports) {
"use strict";

exports.__esModule = true;

exports.handleItemClick = function (item, onChange) {
  var value = item.value;
  onChange(value);
};

exports.hasDuplicatedItems = function (items) {
  var unique = {};
  var isUnique = true;
...
exports.hasValidValue = function (items, value) {
  if (value === undefined) {
    return true;
  }
...
},{}],"../../src/Dropdown/Dropdown.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../../src/Dropdown/Dropdown.ts":[function(require,module,exports) {
"use strict";
...
var list_item_template_1 = __importDefault(require("../common/list-item-template")); // import Message from '../constant/Message';


var selection_single_1 = require("../common/selection-single");
...
function (_super) {
  ...
  function Dropdown() {
    ...
    _this._hideItems = function (evt) {
      ...
      document.removeEventListener('click', _this._hideItems); // TODO: fix to toggle the dropdown list
    };
  ...
  Dropdown.prototype._getItemsStyle = function (_a) {
    var isVisibleItems = _a.isVisibleItems,
        isDisabled = _a.isDisabled;
    var display = isVisibleItems && !isDisabled ? {
      display: 'block'
    } : {
      display: 'none'
    };
  ...
  Dropdown.prototype.template = function (_a) {
    var _this = this;
    ...
    var value = _a.value,
        ...
        isDisabled = _a.isDisabled,
        isVisibleItems = _a.isVisibleItems;
    ...
    var renderItems = function renderItems(items) {
      return items.map(function (item, i) {
        return list_item_template_1["default"]({
          selected: value === item.value,
          onClick: function onClick(item_prop) {
            return selection_single_1.handleItemClick(item_prop, _this._onChange);
          },
          item: item,
...
var templateObject_1;
},{"lit-html/directives/style-map":"../../node_modules/lit-html/directives/style-map.js","../common":"../../src/common/index.ts","../common/list-item-template":"../../src/common/list-item-template.ts","../common/selection-single":"../../src/common/selection-single.ts","./Dropdown.css":"../../src/Dropdown/Dropdown.css"}],"../../src/Dropdown/index.ts":[function(require,module,exports) {
"use strict";
...
},{"./Dropdown":"../../src/Dropdown/Dropdown.ts"}],"../../src/index.ts":[function(require,module,exports) {
"use strict";
...
},{"./Common/common.css":"../../src/Common/common.css","./Button":"../../src/Button/index.ts","./Text":"../../src/Text/index.ts","./Dropdown":"../../src/Dropdown/index.ts"}],"index.ts":[function(require,module,exports) {
"use strict";
...
var mainEl = document.querySelector('main'); // text box

var textboxSection = section_1.createSection('Textbox').appendTo(mainEl);
var txt1 = new src_1.Text();
txt1.on('input', function (_a) {
  var target = _a.target;
  return console.log('txt1:', target.value);
});
textboxSection.appendChild(txt1.render());
var txt2 = new src_1.Text({
  value: 'read only',
  isDisabled: true
});
textboxSection.appendChild(txt2.render()); // button

var buttonSection = section_1.createSection('Button').appendTo(mainEl);
var btn1 = new src_1.Button({
  text: 'Button 1'
});
btn1.on('click', function () {
  return console.log('"Button 1" is clicked');
});
buttonSection.appendChild(btn1.render());
var btn2 = new src_1.Button({
  text: 'Button 2',
  type: 'submit'
});
btn2.on('click', function () {
  return console.log('"Button 2" is clicked');
});
buttonSection.appendChild(btn2.render());
var btn3 = new src_1.Button({
  text: 'Button 3',
  isDisabled: true
});
buttonSection.appendChild(btn3.render()); // dropdown

var dropdownSection = section_1.createSection('Dropdown').appendTo(mainEl);
var dropdown1 = new src_1.Dropdown({
  items: [{
    label: 'Orange',
    value: 'Orange'
  }, {
...
dropdown1.on('change', function (_a) {
  var detail = _a.detail;
  return console.log("The \"" + detail.value + "\" is selected.");
});
dropdownSection.appendChild(dropdown1.render());
var dropdown2 = new src_1.Dropdown({
  items: [{
    label: 'iPhone 6',
    value: 'iPhone 6'
  }, {
...
dropdown2.on('change', function (_a) {
  var detail = _a.detail;
  return console.log("The \"" + detail.value + "\" is selected.");
});
dropdownSection.appendChild(dropdown2.render());
},{"./section":"section.ts","../../src":"../../src/index.ts"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
